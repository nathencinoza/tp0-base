...
Se modificó el servidor para que acepte conexiones y procese mensajes en paralelo. Para ello se utilizó la librería `threading` de Python. Se creó un thread por cada conexión aceptada, el cual se encarga de recibir y enviar mensajes al cliente.
